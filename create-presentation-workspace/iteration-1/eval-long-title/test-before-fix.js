// 수정 전(현재): addTitleBar의 w:10, h:0.6, autoFit 없음
...
// 현재 버전 addTitleBar (w:10, h:0.6, autoFit 없음)
function addTitleBar_BEFORE(slide, title, subtitle = '') {
...
testTitles.forEach((title, i) => {
  ...
  addTitleBar_BEFORE(slide, title);
...
const outputPath = path.join(__dirname, 'without_fix/outputs/before-fix.pptx');
