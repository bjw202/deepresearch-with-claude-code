...
Agent(
  ...
  prompt: "에이전트 정의: .claude/agents/researcher.md의 지침을 Read하여 따르라.
           ...
           [사고 지침 리마인더]
           researcher.md의 6가지 사고 지침을 반드시 확인하라:
           (1) [인접 도메인] 태깅 — 다른 도메인 수치 사용 시 필수
           (2) 반증 탐색 — 핵심 주장 발견 시 반대 증거 검색, 없으면 '반증 미발견' 명시
           (3) 수치 오류 조건 — '이 수치가 틀릴 수 있는 조건' 한 문장 기술
           (4) 관점 확장 — 인접 질문 1~2개 + (있으면) 이질 도메인 유사 사례

           [팀 통신]
           Solo 모드: 팀 통신 불필요. 산출물 파일 저장만 수행하라.",
