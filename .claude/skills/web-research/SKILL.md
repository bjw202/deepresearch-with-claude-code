...
| **stakeholder** | 이해당사자가 발표 (경쟁사, 벤더, 자사 벤치마크) | 경쟁 제품 판매사 블로그, 벤더 백서, 자사 성능 비교 |
| **unverified** | 검증되지 않은 정보 | 익명 소스, 루머, 단일 소스 보도 |

**확신도 매핑**: official → ★★★, reliable → ★★☆, stakeholder → ★☆☆ (독립 검증이 있으면 ★★☆로 상향 가능), unverified → ★☆☆. 산출물의 출처 목록에 확신도를 표기할 때 이 매핑을 따른다.

**이해당사자 판별 기준**: 출처가 조사 대상의 경쟁 제품을 판매하거나, 자사 제품의 우위를 주장하거나, 벤치마크의 비교 기준이 자사에 유리하게 설정된 경우 `stakeholder`로 분류한다.
